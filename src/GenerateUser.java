...
public class GenerateUser {
	...
	public boolean isHealthyWeight() {
		double compare =  (11.0/56.0)*(weight-210)+77;
		if(height>compare)
			return true;
		return false;
	}
	public boolean isOverweight() {
		double compare =  (19.0/112.0)*(weight-266)+79;
		if(height>compare)
			return true;
		return false;
	}
	...
	//		double compare = (12.0/42.0)*(weight-98)+61;
	//		if(height>compare) {
	//			return "You at at an underweight range for your characteristics.";
	//		}
	...
	//	}
		...
		public boolean isFit() {
			if(sex)
				if (determineBodyFatPercent() > 14 && determineBodyFatPercent() < 17)
					return true;
			if(!sex)
				if(determineBodyFatPercent()>21||determineBodyFatPercent()<24)
					return true;
			return false;
		}
		public boolean isAverage() {
			if(sex)
				if (determineBodyFatPercent() > 18 && determineBodyFatPercent() < 25)
					return true;
			if(!sex)
				if(determineBodyFatPercent()>25||determineBodyFatPercent()<31)
					return true;
			return false;
		}
		public boolean isOverweight() {
			if(sex)
				if (determineBodyFatPercent() >25)
					return true;
			if(!sex)
				if (determineBodyFatPercent()>32)
					return true;
			return false;
		}
	}
